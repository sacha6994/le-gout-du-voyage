    ...
    <section ref={ref} id="terrasse" className="py-24 md:py-32 bg-noir">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-br from-tropical/20 via-noir-light to-noir flex items-center justify-center">
              <div className="text-center">
                <svg
                  className="w-16 h-16 text-or/20 mx-auto mb-3"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                <p className="text-or/30 text-sm tracking-widest uppercase">
                  La Terrasse
                </p>
              </div>
            </div>
